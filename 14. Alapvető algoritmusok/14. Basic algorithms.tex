...
% Status: READY TO VERIFY -- please review against the original Hungarian .tex
...
\begin{center}
\fbox{\parbox{0.92\textwidth}{\small \textit{Note: This document was translated from Hungarian to English by AI. The content is ready for review -- please verify the information against the original Hungarian source before relying on it.}}}
\end{center}
